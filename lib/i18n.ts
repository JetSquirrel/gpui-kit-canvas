...
const UI = {
  ...
  alignHintOne: {
    ja: "ウィンドウの本文領域（タイトルバーやサイドバーを除いた余白の内側）に揃えます。",
    en: "Lines the part up with the window's body, inside the padding and clear of the title bar and sidebar.",
    zh: "与窗口正文区域（标题栏和侧边栏以外、内边距以内）对齐。",
  },
  alignHintMany: {
    ja: "選択した部品同士で揃えます。均等配置は両端を固定して間を等間隔にします。",
    en: "Lines the selected parts up with each other. Spacing evenly keeps the two outer parts in place.",
    zh: "选中的组件之间互相对齐。等距分布会固定两端组件。",
  },
